...
fun SortFilterBottomSheet(
    ...
    ModalBottomSheet(
        ...
        Column(
            ...
            Text(
                text = androidx.compose.ui.res.stringResource(com.aktarjabed.jagallery.R.string.sort_filter_title),
            ...
            Text(
                text = androidx.compose.ui.res.stringResource(com.aktarjabed.jagallery.R.string.sort_by_label),
            ...
            Text(
                text = androidx.compose.ui.res.stringResource(com.aktarjabed.jagallery.R.string.sort_order_label),
                style = androidx.compose.material3.MaterialTheme.typography.titleMedium
            )
            ...
            Text(
                text = androidx.compose.ui.res.stringResource(com.aktarjabed.jagallery.R.string.filter_media_label),
                style = androidx.compose.material3.MaterialTheme.typography.titleMedium
            )
                ...
                MediaTypeFilter.entries.forEach { filter ->
                    FilterChip(
                        ...
                        label = {
                            Text(
                                when (filter) {
                                    MediaTypeFilter.ALL -> androidx.compose.ui.res.stringResource(com.aktarjabed.jagallery.R.string.filter_all)
                                    MediaTypeFilter.IMAGES_ONLY -> androidx.compose.ui.res.stringResource(com.aktarjabed.jagallery.R.string.filter_images_only)
                                    MediaTypeFilter.VIDEOS_ONLY -> androidx.compose.ui.res.stringResource(com.aktarjabed.jagallery.R.string.filter_videos_only)
                                }
                            )
                        }
                    )
            ...
            Row(
                ...
                TextButton(onClick = onDismiss) {
                    Text(androidx.compose.ui.res.stringResource(com.aktarjabed.jagallery.R.string.sort_filter_close))
                }
                Spacer(modifier = Modifier.padding(8.dp))
                androidx.compose.material3.Button(onClick = {
                    onApply(pendingSortOption, pendingSortOrder, pendingFilter)
                }) {
                    Text(androidx.compose.ui.res.stringResource(com.aktarjabed.jagallery.R.string.sort_filter_apply))
                }
            }
        }
    }
